    ...
    if clientes.empty or produtos.empty:
        ...
        if adicionar_scanner:
            ...
            if not codigo_busca:
                ...
                # Primeiro procura no CÓDIGO BARRAS. Se não achar, aceita CÓDIGO interno como compatibilidade.
                ...
                if encontrados.empty:
                    st.error(
                        f"Código {codigo_busca} ainda não está vinculado a nenhum produto. "
                        "Vá em Produtos / Estoque → Vincular código de barras, escolha o produto e passe o leitor uma vez."
                    )
